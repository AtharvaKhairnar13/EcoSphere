              ...
              <SidebarLinkGroup activecondition={pathname.includes("settings")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                      to="/dashboard/settings" // Use `to` for routing to the EcoLab page
                      className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                    ...
                    >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            ...
                            <svg className={`shrink-0 fill-current ${pathname.includes('/dashboard/settings') ? 'text-green-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 448 512">
